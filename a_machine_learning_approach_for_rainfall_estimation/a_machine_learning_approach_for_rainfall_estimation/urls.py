...
urlpatterns = [
    ...
    url(r'^Rainfall_Estimate_Prediction_Type/$', remoteuser.Rainfall_Estimate_Prediction_Type, name="Rainfall_Estimate_Prediction_Type"),
    ...
    url(r'^Find_Rainfall_Estimate_Prediction_Type_Ratio/$', serviceprovider.Find_Rainfall_Estimate_Prediction_Type_Ratio, name="Find_Rainfall_Estimate_Prediction_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Rainfall_Estimate_Prediction_Type/$', serviceprovider.View_Rainfall_Estimate_Prediction_Type, name="View_Rainfall_Estimate_Prediction_Type"),
